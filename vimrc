...
" has to be here, because system bar is already sourced when gvimrc is read
set guioptions-=M " menubar

" PROFILE
" on load, write ;profile pause and quit to end
...
"set tildeop " makes tilde accept a motion to change case
...
" -- Searching --
	...
	nnoremap <leader>is :Issue<cr>
	nnoremap <leader>bu :Bug<cr>
...
" conceal feature
	...
	" TODO unset hlsearch after substitute command
